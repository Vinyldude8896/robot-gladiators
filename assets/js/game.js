...
var fight = function(enemy) {
    ...
    console.log(
      playerInfo.name + ' attacked ' + enemy.name + '. ' + enemy.name + ' now has ' + enemy.healthh + ' health remaining.'
    );
...
var endGame = function() {
  ...
  //if player has more money than the high score, player has new high scoire!
